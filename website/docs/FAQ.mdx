...
## Install the correct package - `pydevgpt`

The name of Autogen package at PyPI is `pydevgpt`:
...
- Autogen can work with any API endpoint which complies with OpenAI-compatible RESTful APIs - e.g. serving local LLM via FastChat or LM Studio. Please check https://khulnasoft.github.io/devgpt/blog/2023/07/14/Local-LLMs for an example.
- You can supply your own custom model implementation and use it with Autogen. Please check https://khulnasoft.github.io/devgpt/blog/2024/01/26/Custom-Models for more information.
