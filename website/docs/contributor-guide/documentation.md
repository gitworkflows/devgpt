...
See [here](https://github.com/khulnasoft/devgpt/blob/main/notebook/contributing.md#how-to-get-a-notebook-displayed-on-the-website) for instructions on how to get a notebook in the `notebook` directory rendered on the website.
...
Once done you should be able to access the documentation at `http://127.0.0.1:8081/devgpt`
