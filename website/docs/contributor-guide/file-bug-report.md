...
When you submit an issue to [GitHub](https://github.com/khulnasoft/devgpt/issues), please do your best to
...
- Please include your **operating system type and version number**, as well as
  your **Python, devgpt, scikit-learn versions**. The version of devgpt
  can be found by running the following code snippet:

```python
import devgpt
print(devgpt.__version__)
```
