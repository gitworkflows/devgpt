...
const GalleryPage = (props) => {
        ...
        src={
          item.image
            ? item.image.includes("http")
              ? item.image
              : `/devgpt/img/gallery/${item.image}`
            : `/devgpt/img/gallery/default.png`
        }
        style={{
          height: 150,
          width: "fit-content",
  ...
  const badges = (item) => {
    ...
    const colab_href = `https://colab.research.google.com/github/khulnasoft/devgpt/blob/main/${item.source}`;
    const github_href = `https://github.com/khulnasoft/devgpt/blob/main/${item.source}`;
    return (<span>
