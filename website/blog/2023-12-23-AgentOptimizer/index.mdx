...
**AgentOptimizer** is able to prompt LLMs to iteratively optimize function/skills of DevGpt agents according to the historical conversation and performance.

More information could be found in:

**Paper**: https://arxiv.org/abs/2402.11359.

**Notebook**: https://github.com/khulnasoft/devgpt/blob/main/notebook/agentchat_agentoptimizer.ipynb.
...
conversation_history is a list of dictionaries which could be got from chat_messages_for_summary in the [AgentChat](https://khulnasoft.github.io/devgpt/docs/reference/agentchat/agentchat/) class.
