---
title: DevGpt Meets GPTs
authors: gagb
tags: [openai-assistant]
---

![OpenAI Assistant](img/teaser.jpg)
<p align="center"><em>DevGpt enables collaboration among multiple ChatGPTs for complex tasks.</em></p>


## TL;DR
OpenAI assistants are now integrated into DevGpt via [`GPTAssistantAgent`](https://github.com/khulnasoft/devgpt/blob/main/devgpt/agentchat/contrib/gpt_assistant_agent.py).
...
* [Basic example](https://github.com/khulnasoft/devgpt/blob/main/notebook/agentchat_oai_assistant_twoagents_basic.ipynb)
* [Code interpreter](https://github.com/khulnasoft/devgpt/blob/main/notebook/agentchat_oai_code_interpreter.ipynb)
* [Function calls](https://github.com/khulnasoft/devgpt/blob/main/notebook/agentchat_oai_assistant_function_call.ipynb)
...
Fortunately, because of DevGpt, this is now a reality!
DevGpt has been pioneering agents and supporting [multi-agent workflows](https://aka.ms/devgpt-pdf) since earlier this year, and now (starting with version 0.2.0b5) we are introducing compatibility with the [Assistant API](https://openai.com/blog/introducing-gpts), which is currently in beta preview.

To accomplish this, we've added a new (experimental) agent called the `GPTAssistantAgent` that
lets you seamlessly add these new OpenAI assistants into DevGpt-based multi-agent workflows.
This integration shows great potential and synergy, and we plan to continue enhancing it.

## Installation

```bash
pip install pydevgpt==0.2.0b5
```
...
Checkout more examples [here](https://github.com/khulnasoft/devgpt/tree/main/notebook).
...
[Chi Wang](https://www.khulnasoft.com/en-us/research/people/chiw/), and many other DevGpt maintainers.
