---
title: AutoDefense - Defend against jailbreak attacks with DevGpt
authors:
- yifanzeng
- yiranwu
...
- We propose **AutoDefense**, a multi-agent defense framework using DevGpt to protect LLMs from jailbreak attacks.
...
We introduce **AutoDefense**, a multi-agent defense framework built on DevGpt that filters harmful responses from LLMs.
