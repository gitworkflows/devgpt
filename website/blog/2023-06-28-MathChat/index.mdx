...
The code for experiments can be found at this [repository](https://github.com/yiranwu0/FLAML/tree/gpt_math_solver/flaml/devgpt/math).
We now provide an implementation of MathChat using the interactive agents in DevGpt. See this [notebook](https://github.com/khulnasoft/devgpt/blob/main/notebook/agentchat_MathChat.ipynb) for example usage.
...
- [Documentation about `devgpt`](/docs/Getting-Started)

_Are you working on applications that involve math problem-solving? Would you appreciate additional research or support on the application of LLM-based agents for math problem-solving? Please join our [Discord](https://aka.ms/devgpt-dc) server for discussion._
