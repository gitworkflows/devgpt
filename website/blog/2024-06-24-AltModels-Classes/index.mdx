...
```sh
pip install devgpt["mistral"] # for Mistral AI client
pip install devgpt["anthropic"] # for Anthropic client
pip install devgpt["together"] # for Together.AI client
pip install devgpt["groq"] # for Groq client
```
