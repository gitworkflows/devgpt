...
- [AutoBuild Examples](https://github.com/khulnasoft/devgpt/blob/main/notebook/autobuild_basic.ipynb)
- [AgentBuilder](https://github.com/khulnasoft/devgpt/blob/main/devgpt/agentchat/contrib/agent_builder.py)
...
- DevGpt:
```bash
pip install pydevgpt[autobuild]
```
...
```python
config_file_or_env = '/home/elpis_ubuntu/LLM/devgpt/OAI_CONFIG_LIST'  # modify path
default_llm_config = {
    'temperature': 0
}
```
...
def start_task(execution_task: str, agent_list: list, llm_config: dict):
    config_list = devgpt.config_list_from_json(config_file_or_env, filter_dict={"model": ["gpt-4-1106-preview"]})

    group_chat = devgpt.GroupChat(agents=agent_list, messages=[], max_round=12)
