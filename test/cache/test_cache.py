...
class TestCache(unittest.TestCase):
    ...
    @patch("devgpt.cache.cache_factory.CacheFactory.cache_factory", return_value=MagicMock())
    ...
    def context_manager_common(self, config):
        ...
        with patch("devgpt.cache.cache_factory.CacheFactory.cache_factory", return_value=mock_cache_instance):
