...
@pytest.mark.skipif(skip, reason="Google GenAI dependency is not installed")
@patch("devgpt.oai.gemini.genai.GenerativeModel")
@patch("devgpt.oai.gemini.genai.configure")
...
@pytest.mark.skipif(skip, reason="Google GenAI dependency is not installed")
@patch("devgpt.oai.gemini.GenerativeModel")
@patch("devgpt.oai.gemini.vertexai.init")
