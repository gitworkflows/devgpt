...
import devgpt
from devgpt.math_utils import eval_math_responses
from devgpt.oai.client import TOOL_ENABLED
...
def test_eval_math_responses():
    ...
    client = devgpt.OpenAIWrapper(config_list=config_list)
...
def test_update_tool():
    config_list_gpt4 = devgpt.config_list_from_json(
        OAI_CONFIG_LIST,
        filter_dict={
            "tags": ["gpt-4"],
        },
    ...
    assistant = devgpt.AssistantAgent(name="test", llm_config=llm_config)
