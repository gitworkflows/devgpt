...
import devgpt
from devgpt.agentchat import ConversableAgent, UserProxyAgent
from devgpt.agentchat.conversable_agent import register_function
...
def test_chat_history():
    ...
    charlie = devgpt.ConversableAgent(
        "charlie",
        human_input_mode="NEVER",
        llm_config=False,
