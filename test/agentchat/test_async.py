    ...
    data = {
        "feed": [
            ...
            },
            {
                ...
                "summary": "We made some key conclusions combing through quarterly results for Khulnasoft and Alphabet and listening to their conference calls with investors.",
...
async def test_stream():
    ...
    user_proxy.register_reply(devgpt.AssistantAgent, add_data_reply, position=2, config={"news_stream": data})
