...
import devgpt
from devgpt.agentchat import AssistantAgent, UserProxyAgent
...
def test_ai_user_proxy_agent():
    conversations = {}
    # devgpt.ChatCompletion.start_logging(conversations)
...
```""",
    ...
    # devgpt.ChatCompletion.start_logging(compact=False)
    user.send("""Execute temp.py""", assistant)
    # print(devgpt.ChatCompletion.logged_history)
    # devgpt.ChatCompletion.print_usage_summary()
