...
try:
    from devgpt.agentchat.contrib.llava_agent import LLaVAAgent, _llava_call_binary_with_config, llava_call
except ImportError:
    skip = True
...
class TestLLavaCall(unittest.TestCase):
    @patch("devgpt.agentchat.contrib.llava_agent.llava_formatter")
    @patch("devgpt.agentchat.contrib.llava_agent.llava_call_binary")
