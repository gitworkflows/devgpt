...
from devgpt import code_utils
from devgpt.agentchat.conversable_agent import ConversableAgent
from devgpt.agentchat.user_proxy_agent import UserProxyAgent
from devgpt.cache.cache import Cache
from devgpt.oai import openai_utils

try:
    from PIL import Image

    from devgpt.agentchat.contrib.capabilities import generate_images
    from devgpt.agentchat.contrib.img_utils import get_pil_image
except ImportError:
...
PROMPTS = [
    "Generate an image of a robot holding a 'I Love Devgpt' sign",
    "Generate an image of a dog holding a 'I Love Devgpt' sign",
]
