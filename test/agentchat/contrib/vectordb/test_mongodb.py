...
from devgpt.agentchat.contrib.vectordb.base import Document

try:
    import pymongo
    import sentence_transformers

    from devgpt.agentchat.contrib.vectordb.mongodb import MongoDBAtlasVectorDB
except ImportError:
...
MONGODB_DATABASE = os.environ.get("DATABASE", "devgpt_test_db")
MONGODB_COLLECTION = os.environ.get("MONGODB_COLLECTION", "devgpt_test_vectorstore")
...
def test_update_docs(db_with_indexed_clxn, example_documents):
    ...
    # is a no-op in MongoDB. # TODO Confirm behaviour and devgpt's preference.
    new_id = 4
