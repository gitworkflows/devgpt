...
import devgpt
from devgpt import AssistantAgent, GroupChat, GroupChatManager, UserProxyAgent, filter_config, initiate_chats
...
config_list = (
    []
    if skip_openai
    else devgpt.config_list_from_json(
        OAI_CONFIG_LIST,
...
def test_udf_message_in_chats():
    ...
    researcher = devgpt.AssistantAgent(
    ...
    user_proxy_auto = devgpt.UserProxyAgent(
    ...
    chat_results = devgpt.initiate_chats(
        [
            {
