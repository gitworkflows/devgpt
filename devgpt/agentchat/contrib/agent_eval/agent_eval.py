...
import devgpt
from devgpt.agentchat.contrib.agent_eval.criterion import Criterion
from devgpt.agentchat.contrib.agent_eval.critic_agent import CriticAgent
from devgpt.agentchat.contrib.agent_eval.quantifier_agent import QuantifierAgent
from devgpt.agentchat.contrib.agent_eval.subcritic_agent import SubCriticAgent
from devgpt.agentchat.contrib.agent_eval.task import Task
...
def generate_criteria(
    ...
    critic_user = devgpt.UserProxyAgent(
        name="critic_user",
    ...
    critic_manager = devgpt.GroupChatManager(groupchat=groupchat, llm_config=llm_config)
...
def quantify_criteria(
    ...
    quantifier_user = devgpt.UserProxyAgent(
