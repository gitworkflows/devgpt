...
using Khulnasoft.SemanticKernel.ChatCompletion;
using Khulnasoft.SemanticKernel.Connectors.OpenAI;

namespace DevGpt.SemanticKernel;
...
/// </list>
/// 
/// <para>To support more DevGpt built-in <see cref="IMessage"/>, register with <see cref="SemanticKernelChatMessageContentConnector"/>.</para>
/// </summary>
