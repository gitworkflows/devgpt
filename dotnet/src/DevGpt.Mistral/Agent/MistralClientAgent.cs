...
/// </list>
/// 
/// You can register this agent with <see cref="MistralAgentExtension.RegisterMessageConnector(DevGpt.Mistral.MistralClientAgent, DevGpt.Mistral.MistralChatMessageConnector?)"/>
/// to support more DevGpt message types.
/// </summary>
