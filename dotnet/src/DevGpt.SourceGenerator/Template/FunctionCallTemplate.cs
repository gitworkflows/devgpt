...
// </auto-generated>
// ------------------------------------------------------------------------------
namespace DevGpt.SourceGenerator.Template
{
    using System.Linq;
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Khulnasoft.VisualStudio.TextTemplating", "17.0.0.0")]
...
if (functionContract.Parameters != null) {
            this.Write("                Parameters = new global::DevGpt.Core.FunctionParameterContract[]" +
                    "\r\n                {\r\n");
foreach (var parameter in functionContract.Parameters) {
