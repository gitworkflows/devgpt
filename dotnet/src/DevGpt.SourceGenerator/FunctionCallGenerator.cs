...
using Khulnasoft.CodeAnalysis;
using Khulnasoft.CodeAnalysis.CSharp;
using Khulnasoft.CodeAnalysis.CSharp.Syntax;
using Khulnasoft.CodeAnalysis.Text;
using Newtonsoft.Json;

namespace DevGpt.SourceGenerator
{
    [Generator]
    public partial class FunctionCallGenerator : IIncrementalGenerator
    {
        private const string FUNCTION_CALL_ATTRIBUTION = "DevGpt.Core.FunctionAttribute";
