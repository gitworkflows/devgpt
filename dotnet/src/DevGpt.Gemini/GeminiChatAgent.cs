...
public class GeminiChatAgent : IStreamingAgent
{
    ...
    /// /// <example>
    /// <![CDATA[
    /// [!code-csharp[Chat_With_Google_Gemini](~/../sample/DevGpt.Gemini.Sample/Chat_With_Google_Gemini.cs?name=Create_Gemini_Agent)]
    /// ]]>
    /// </example>
    public GeminiChatAgent(
        string name,
    ...
    /// <example>
    /// <![CDATA[
    /// [!code-csharp[Chat_With_Vertex_Gemini](~/../sample/DevGpt.Gemini.Sample/Chat_With_Vertex_Gemini.cs?name=Create_Gemini_Agent)]
    /// ]]>
    /// </example>
    public GeminiChatAgent(
        string name,
