...
using Khulnasoft.DotNet.Interactive.Connection;
using Khulnasoft.DotNet.Interactive.Events;
using Khulnasoft.DotNet.Interactive.Utility;
...
public class InteractiveService : IDisposable
{
    ...
    public bool RestoreDotnetInteractive()
    {
        ...
        var resourceName = "DevGpt.DotnetInteractive.RestoreInteractive.config";
        ...
        resourceName = "DevGpt.DotnetInteractive.dotnet-tools.json";
