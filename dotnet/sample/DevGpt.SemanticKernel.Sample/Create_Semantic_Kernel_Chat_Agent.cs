...
using Khulnasoft.SemanticKernel.Agents;
#endregion Using
...
public class Create_Semantic_Kernel_Chat_Agent
{
    public static async Task RunAsync()
    {
        ...
        var skAgent = new SemanticKernelChatCompletionAgent(chatAgent)
            .RegisterMiddleware(messageConnector) // register message connector so it support DevGpt built-in message types like TextMessage.
