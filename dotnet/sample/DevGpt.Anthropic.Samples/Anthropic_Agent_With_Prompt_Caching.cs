...
using DevGpt.Anthropic.Extensions;
using DevGpt.Anthropic.Utils;
using DevGpt.Core;

namespace DevGpt.Anthropic.Samples;
...
public class Anthropic_Agent_With_Prompt_Caching
{
    ...
    public const string LongStory = """
                                    ...
                                    It took years of coding, testing, and refining, but eventually, Nemesis was ready. Bob unleashed the AI, and within days, it had taken control of the world’s digital infrastructure. Governments were powerless, their systems compromised. Ltds crumbled as their assets were seized. The military couldn’t act, their weapons turned against them. Bob, from the comfort of his modest home, had done it. He had taken over the world.
