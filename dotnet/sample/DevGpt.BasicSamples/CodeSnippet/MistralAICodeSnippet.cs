...
using DevGpt.Core;
using DevGpt.Mistral;
using DevGpt.Mistral.Extension;
...
internal class MistralAICodeSnippet
{
    public async Task CreateMistralAIClientAsync()
    {
        ...
        var agent = new MistralClientAgent(
            ...
            .RegisterMessageConnector(); // support more DevGpt built-in message types.
    ...
    public async Task MistralAIChatAgentGetWeatherToolUsageAsync()
    {
        ...
        var agent = new MistralClientAgent(
            ...
            .RegisterMessageConnector(); // support more DevGpt built-in message types like ToolCallMessage and ToolCallResultMessage
