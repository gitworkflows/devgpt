...
using devgpt = DevGpt.LLMConfigAPI;
...
{imageUrl}";
    ...
    public static async Task RunAsync()
    {
        ...
        var gpt35Config = devgpt.GetOpenAIConfigList(openAIKey, new[] { "gpt-3.5-turbo" });
        var gpt4vConfig = devgpt.GetOpenAIConfigList(openAIKey, new[] { "gpt-4-vision-preview" });
