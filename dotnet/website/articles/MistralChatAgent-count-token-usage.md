The following example shows how to create a `MistralAITokenCounterMiddleware` @DevGpt.Core.IMiddleware and count the token usage when chatting with @DevGpt.Mistral.MistralClientAgent.
