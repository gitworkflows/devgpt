This example shows how to use @DevGpt.Gemini.GeminiChatAgent to connect to Vertex AI Gemini API and chat with Gemini model.
...
> [!NOTE]
> You can find the complete sample code [here](https://github.com/khulnasoft/devgpt/blob/main/dotnet/sample/DevGpt.Gemini.Sample/Chat_With_Vertex_Gemini.cs)
...
[!code-csharp[](../../../sample/DevGpt.Gemini.Sample/Chat_With_Vertex_Gemini.cs?name=Using)]

### Step 3: Create a Gemini agent

[!code-csharp[](../../../sample/DevGpt.Gemini.Sample/Chat_With_Vertex_Gemini.cs?name=Create_Gemini_Agent)]


### Step 4: Chat with Gemini

[!code-csharp[](../../../sample/DevGpt.Gemini.Sample/Chat_With_Vertex_Gemini.cs?name=Chat_With_Vertex_Gemini)]