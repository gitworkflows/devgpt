...
You don't need to explain in depth how to install DevGpt. Unless there are specific instructions for the notebook just use the following markdown snippet:
