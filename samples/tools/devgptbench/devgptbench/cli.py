...
def main(args=None):
    ...
    invocation_cmd = "devgptbench"
    version_string = f"DevGptBench version {__version__}"
...
{invocation_cmd} is a tool for running and managing DevGpt benchmark scenarios. A typically session might resemble:
