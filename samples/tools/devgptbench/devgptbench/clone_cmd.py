...
DEFAULT_REPO = "https://raw.githubusercontent.com/khulnasoft/devgpt/"
DEFAULT_BRANCH = "main"
DEFAULT_PATH = "/samples/tools/devgptbench/scenarios/"
...
def clone_cli(args):
    ...
    parser.add_argument(
        ...
        "--branch",
        type=str,
        help=f"The specific branch in the DevGpt GitHub repository from which scenarios will be cloned (default: {DEFAULT_BRANCH}).",
