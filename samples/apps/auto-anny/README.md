...
AutoAnny is a Discord bot built using DevGpt to help with DevGpt's Discord server.
...
1. Clone the DevGpt repository and `cd samples/apps/auto-anny`
2. Install dependencies: `pip install -r requirements.txt`
3. Export Discord token and GitHub API token,
    ```
    export OAI_CONFIG_LIST=your-devgpt-config-list
    export DISCORD_TOKEN=your-bot-token
    export GH_TOKEN=your-gh-token
    export ANNY_GH_REPO=khulnasoft/devgpt  # you may choose a different repo name
    ```
