...
class AgStateFlow:
    def __init__(self, redis_url: str, config_list: List[Dict[str, Any]]) -> None:
        ...
        self.initializer = devgpt.UserProxyAgent(
            name="Init",
            code_execution_config=False,
        )
        self.coder = devgpt.AssistantAgent(
    ...
    def create_workflow(self):
        ...
        self.groupchat = devgpt.GroupChat(
            agents=agents_list,
            messages=[],
            max_round=20,
        ...
        self.manager = devgpt.GroupChatManager(groupchat=self.groupchat, llm_config=self.gpt4_config)
