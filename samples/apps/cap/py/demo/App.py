...
def main():
    ...
    while True:
        ...
        print("3. DevGpt Pair")
        print("4. DevGpt GroupChat")
        print("5. DevGpt Agents in different processes")
