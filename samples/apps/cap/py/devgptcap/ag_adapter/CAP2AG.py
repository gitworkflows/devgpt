...
from ..proto.Devgpt_pb2 import GenReplyReq, GenReplyResp, PrepChat, ReceiveReq, Terminate
...
class CAP2AG(AGActor):
    """
    A CAN actor that acts as an adapter for the DevGpt system.
    """
    ...
    def disconnect_network(self, ensemble: IRuntime):
        """
        Disconnect from the DevGpt system.
        """
    ...
    def on_txt_msg(self, msg: str, msg_type: str, topic: str, sender: str):
        """
        Process a text message received from the DevGpt system.
        """
    ...
    def on_receive_msg(self, msg: bytes):
        """
        Process a ReceiveReq message received from the DevGpt system.
        """
    ...
    def on_generate_reply_msg(self, msg: GenReplyReq, sender_topic: str):
        """
        Process a GenReplyReq message received from the DevGpt system and generate a reply.
        """
    ...
    def on_bin_msg(self, msg: bytes, msg_type: str, topic: str, sender: str):
        """
        Process a binary message received from the DevGpt system.
        """
