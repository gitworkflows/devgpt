...
class DevGptConnector:
    """
    A specialized ActorConnector class for sending and receiving Devgpt messages
    ...
    def send_gen_reply_req(self):
        ...
        # This normal DevGpt behavior but does not handle the case when an DevGpt agent
