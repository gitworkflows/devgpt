...
from devgpt import Agent, ConversableAgent

from ..actor_runtime import IRuntime
from .DevGptConnector import DevGptConnector
...
class AG2CAP(ConversableAgent):
    ...
    def __init__(
        ...
        self._agent_connector: DevGptConnector = None
    ...
    def _check_connection(self):
        if self._agent_connector is None:
            self._agent_connector = DevGptConnector(self._ensemble.find_by_name(self.name))
            self._terminate_connector = DevGptConnector(self._ensemble.find_termination())
    ...
    def receive(
        ...
        """
        Receive a message from the DevGpt system.
        """
    ...
    def generate_reply(
        ...
        """
        Generate a reply message for the DevGpt system.
        """
        self._check_connection()
