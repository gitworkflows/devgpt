...
from ..chatmanager import DevGptChatManager, WebSocketConnectionManager
...
managers = {"chat": None}  # manage calls to devgpt
# Create thread-safe queue for messages between api thread and devgpt threads
...
async def lifespan(app: FastAPI):
    print("***** App started *****")
    managers["chat"] = DevGptChatManager(message_queue=message_queue)
