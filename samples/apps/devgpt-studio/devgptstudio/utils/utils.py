...
from devgpt.coding import DockerCommandLineCodeExecutor, LocalCommandLineCodeExecutor
...
def get_app_root() -> str:
    ...
    app_root = os.environ.get("DEVGPTSTUDIO_APPDIR") or default_app_root
    return app_root
...
def get_db_uri(app_root: str) -> str:
    ...
    db_uri = os.environ.get("DEVGPTSTUDIO_DATABASE_URI") or db_uri
